...
> **Version**: v3.8 (2026-06-14) — **M4 complete; ablations/significance passed (`m4-ablations-significance`)**. Full-vs-plain survives BH/FDR on ETTh1/ETTm2/Weather, but the effect is small and entirely attributable to dynamic β; drift-only is significantly worse and rejected. Synthetic regime recovery accuracy is 0.966. The final paper route is an honest empirical/pivot paper: optimal-bias drift measurement + Fixed-Share causal tracker + small dynamic-β improvement + negative learned-router/drift-loop results. v3.7 (2026-06-14): **M3 complete; dynamic β + drift loop passed narrowly (`m3-dynamic-beta-drift-loop`)**. The pivot system improved stress-weighted loss on ETTh1/ETTm2/Weather and β was nontrivial on all three, but the tuned drift gain was 0.0 throughout. v3.6 (2026-06-14): **M2 complete; router viability gate failed on ETTm2 (`m2-router-viability`)**. The minimum viable PRISM router beat descriptor ridge on ETTh1/ETTm2/Weather and beat Fixed-Share on ETTh1/Weather, but failed the preregistered kill criterion on ETTm2. v3.5 (2026-06-14): **M1c complete**. v3.4 (2026-06-13): **M1b complete; gate adjudicated: ETT-only PRISM (§8 pivot clause)**. v3.2 (2026-06-12) recorded M1a results and amended gate protocol. This document is the **single source of truth** for all subsequent coding and experiments.
>
