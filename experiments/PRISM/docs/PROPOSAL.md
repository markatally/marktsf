...
> **Version**: v3.5 (2026-06-14) — **M1c complete after M1b repo-hygiene snapshot (`m1b-finance-gate`)**. M1c ran a lightweight MISO breadth screen on ETTh1/ETTh2/ETTm1/ETTm2/Weather/Exchange (L=96,H=96) with a closed-form heterogeneous predictor pool plus anchors, Fixed-Share bounds, and descriptor→winner probes. Switch structure is broad (switch_ratio 0.076–0.280; oracle gaps 29.9–51.8%) but routability is mixed: positive descriptor-probe lift on ETTh1-light/ETTm2/Weather, flat on ETTm1, negative on ETTh2/Exchange. v3.4 (2026-06-13): **M1b complete; gate adjudicated: ETT-only PRISM (§8 pivot clause)**. M1b ran the full amended protocol: DA/IC decision-loss oracle (killed), CryptoVol (real but bursty, fails strict condition 2), ETTh1 seed bands, expanded CryptoMISO pool, and FI2010 LOB (signal-bearing but fails condition 2). **Final M1b gate**: general-benchmark leg PASS; finance leg no surviving instantiation → ETT-only PRISM is the primary paper. CryptoVol and FI2010 results retained as appendix. v3.3 (2026-06-12) recorded the pre-FI2010 M1b adjudication. v3.2 (2026-06-12) recorded M1a results and amended gate protocol. v3.1 (2026-06-11) incorporated 2026 heterogeneous-MoE wave. v3.0 was the English rewrite. This document is the **single source of truth** for all subsequent coding and experiments.
>
