# Dataset Audit — 15 TSF Papers

> Generated 2026-06-07. Verified against each paper's PDF and official code repository.

## Status Summary

| Status | Count | Datasets |
|--------|-------|---------|
| ✅ Downloaded & verified | 44 items | ETT×4, Weather, Electricity, Traffic, Exchange×2, ILI, Solar×2, PEMS03-08×4 (npz), METR-LA×2, PEMS-BAY×2, M4×12, NN5×3, Wike2000, COVID-19×2, ECG, AQShunyi, AQWan, Wind, SP500, CSI500 (480 stocks), AirConvection (5 stations, 10 vars), UTSD-1G (84 files), BOOM (2.7GB, 2807 dirs) |
| ⏳ In progress | 1 item | Crypto (downloading from Binance Vision, 14 assets 2017-2021) |
...
| Crypto (G-Research 14-asset, 1-min) | ⏳ | Downloading from Binance Vision (alt source); Kaggle: `g-research-crypto-forecasting` |
...
| Crypto | Kaggle G-Research | CSV (7 assets, 1min) | Time-SSM |
...
index = ak.index_stock_cons(symbol="000905")  # CSI500 = 沪深300是000300, CSI500是000905
tickers = index['品种代码'].tolist()
...
### Crypto (for Time-SSM)
```bash
# Requires Kaggle account: https://www.kaggle.com/account
pip install kaggle
kaggle competitions download g-research-crypto-forecasting -p input/Crypto/
cd input/Crypto && unzip "*.zip"
```
